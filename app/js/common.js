...
var log = function log(str) {
	...
	window.sameSizes = function (_) {
		var widthSumm = 0;
		$(".desktop-table__main table tbody tr:first-child td:not(:first-child)").each(function (i, el) {
			var $this = $(el);
	...
	$('.basepage .text-page .standart-slider').each(function (i, el) {
		var $slider = $(el).find('.standart-slider__list');
	...
	$(".times__slider").slick({
		...
		}, _defineProperty(_ref, "breakpoint", 820), _defineProperty(_ref, "settings", {
			slidesToShow: 3
		}), _defineProperty(_ref, "breackpoint", 660), _defineProperty(_ref, "settings", {
			slidesToShow: 1
		}), _ref)]
	});
